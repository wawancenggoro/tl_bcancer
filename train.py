...
TRAIN_INDEXES = HOME_DATA_DIR + 'ChestX-ray14/labels/train_idx.csv'
VAL_INDEXES = HOME_DATA_DIR + 'ChestX-ray14/labels/val_idx.csv'
TEST_INDEXES = HOME_DATA_DIR + 'ChestX-ray14/labels/test_idx.csv'
