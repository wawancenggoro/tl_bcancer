...
class DenseNet121(nn.Module):
    ...
    def __init__(self):
        ...
        # self.densenet121 = models.densenet121(pretrained=True) #ImageNet Pretrained
        self.densenet121 = models.densenet121(pretrained=False) # from scratch
        # num_ftrs = self.densenet121.classifier.in_features
        # self.densenet121.classifier = nn.Sequential(
        #     nn.Linear(num_ftrs, out_size),
        #     nn.Sigmoid()
...
def main():
    ...
    if LAST_PARALLEL_BLOCKS>=1:
        ...
        # model.module.densenet121.features0.denseblock1[5][2].weight.requires_grad = True    
        # model.module.densenet121.features0.denseblock1[5][5].weight.requires_grad = True
        # model.module.densenet121.features1.denseblock1[5][2].weight.requires_grad = True    
        # model.module.densenet121.features1.denseblock1[5][5].weight.requires_grad = True
        # model.module.densenet121.features2.denseblock1[5][2].weight.requires_grad = True    
        # model.module.densenet121.features2.denseblock1[5][5].weight.requires_grad = True
        # model.module.densenet121.features3.denseblock1[5][2].weight.requires_grad = True    
        # model.module.densenet121.features3.denseblock1[5][5].weight.requires_grad = True
    ...
    if TRANSFER_SINGLE_PATH_BLOCKS and TRANSFER_SINGLE_NORM_LAYER:
        ...
        model.module.densenet121.features.norm6.weight.data.copy_(model_source.module.densenet121.features.norm5.weight.data)
        model.module.densenet121.features.norm6.bias.data.copy_(model_source.module.densenet121.features.norm5.bias.data)
        model.module.densenet121.features.norm6.running_mean.copy_(model_source.module.densenet121.features.norm5.running_mean)
        model.module.densenet121.features.norm6.running_var.copy_(model_source.module.densenet121.features.norm5.running_var)
