...
LAST_FROZEN_PARALLEL_LAYER = 2
TRAIN_PARALLEL_NORM_LAYER = True

TRANSFER_SINGLE_PATH_BLOCKS = False

TRANSFER_PARALLEL_NORM_LAYER = True
...
def main():
    ...
    model.module.densenet121.features0.conv0.weight.requires_grad = False
    model.module.densenet121.features1.conv0.weight.requires_grad = False
    model.module.densenet121.features2.conv0.weight.requires_grad = False
    model.module.densenet121.features3.conv0.weight.requires_grad = False
    ...
    if LAST_PARALLEL_BLOCKS>=1:
        ...
        for j in range(BLOCK_CONFIG[0]):
            ...
            for k in [2,5]:
                ...
                if LAST_FROZEN_PARALLEL_LAYER>=1: 
                    model.module.densenet121.features0.denseblock1[j][k].weight.requires_grad = False
                    model.module.densenet121.features1.denseblock1[j][k].weight.requires_grad = False
                    model.module.densenet121.features2.denseblock1[j][k].weight.requires_grad = False
                    model.module.densenet121.features3.denseblock1[j][k].weight.requires_grad = False
                else:                    
                    model.module.densenet121.features0.denseblock1[j][k].weight.requires_grad = True
                    model.module.densenet121.features1.denseblock1[j][k].weight.requires_grad = True
                    model.module.densenet121.features2.denseblock1[j][k].weight.requires_grad = True
                    model.module.densenet121.features3.denseblock1[j][k].weight.requires_grad = True
        ...
        if LAST_PARALLEL_BLOCKS!=1:
            ...
            if LAST_FROZEN_PARALLEL_LAYER>=1: 
                model.module.densenet121.features0.transition1.conv.weight.requires_grad = False
                model.module.densenet121.features1.transition1.conv.weight.requires_grad = False
                model.module.densenet121.features2.transition1.conv.weight.requires_grad = False
                model.module.densenet121.features3.transition1.conv.weight.requires_grad = False
            else:
                model.module.densenet121.features0.transition1.conv.weight.requires_grad = True
                model.module.densenet121.features1.transition1.conv.weight.requires_grad = True
                model.module.densenet121.features2.transition1.conv.weight.requires_grad = True
                model.module.densenet121.features3.transition1.conv.weight.requires_grad = True
     
        # for i in range(2):
        #     model.module.densenet121.features0.denseblock1[BLOCK_CONFIG[0]-i-1][2].weight.requires_grad = True    
        #     model.module.densenet121.features0.denseblock1[BLOCK_CONFIG[0]-i-1][5].weight.requires_grad = True
        #     model.module.densenet121.features1.denseblock1[BLOCK_CONFIG[0]-i-1][2].weight.requires_grad = True    
        #     model.module.densenet121.features1.denseblock1[BLOCK_CONFIG[0]-i-1][5].weight.requires_grad = True
        #     model.module.densenet121.features2.denseblock1[BLOCK_CONFIG[0]-i-1][2].weight.requires_grad = True    
        #     model.module.densenet121.features2.denseblock1[BLOCK_CONFIG[0]-i-1][5].weight.requires_grad = True
        #     model.module.densenet121.features3.denseblock1[BLOCK_CONFIG[0]-i-1][2].weight.requires_grad = True    
        #     model.module.densenet121.features3.denseblock1[BLOCK_CONFIG[0]-i-1][5].weight.requires_grad = True
    ...
    if LAST_PARALLEL_BLOCKS>=2:
        ...
        for j in range(BLOCK_CONFIG[1]):
            ...
            for k in [2,5]:
                ...
                if LAST_FROZEN_PARALLEL_LAYER>=2: 
                    model.module.densenet121.features0.denseblock2[j][k].weight.requires_grad = False
                    model.module.densenet121.features1.denseblock2[j][k].weight.requires_grad = False
                    model.module.densenet121.features2.denseblock2[j][k].weight.requires_grad = False
                    model.module.densenet121.features3.denseblock2[j][k].weight.requires_grad = False
                else:                    
                    model.module.densenet121.features0.denseblock2[j][k].weight.requires_grad = True
                    model.module.densenet121.features1.denseblock2[j][k].weight.requires_grad = True
                    model.module.densenet121.features2.denseblock2[j][k].weight.requires_grad = True
                    model.module.densenet121.features3.denseblock2[j][k].weight.requires_grad = True
        ...
        if LAST_PARALLEL_BLOCKS!=2:
            ...
            if LAST_FROZEN_PARALLEL_LAYER>=2: 
                model.module.densenet121.features0.transition2.conv.weight.requires_grad = False
                model.module.densenet121.features1.transition2.conv.weight.requires_grad = False
                model.module.densenet121.features2.transition2.conv.weight.requires_grad = False
                model.module.densenet121.features3.transition2.conv.weight.requires_grad = False
            else:
                model.module.densenet121.features0.transition2.conv.weight.requires_grad = True
                model.module.densenet121.features1.transition2.conv.weight.requires_grad = True
                model.module.densenet121.features2.transition2.conv.weight.requires_grad = True
                model.module.densenet121.features3.transition2.conv.weight.requires_grad = True

        for i in range(TRAINABLE_LAYERS):
            model.module.densenet121.features0.denseblock2[BLOCK_CONFIG[1]-i-1][2].weight.requires_grad = True    
            model.module.densenet121.features0.denseblock2[BLOCK_CONFIG[1]-i-1][5].weight.requires_grad = True
            model.module.densenet121.features1.denseblock2[BLOCK_CONFIG[1]-i-1][2].weight.requires_grad = True    
            model.module.densenet121.features1.denseblock2[BLOCK_CONFIG[1]-i-1][5].weight.requires_grad = True
            model.module.densenet121.features2.denseblock2[BLOCK_CONFIG[1]-i-1][2].weight.requires_grad = True    
            model.module.densenet121.features2.denseblock2[BLOCK_CONFIG[1]-i-1][5].weight.requires_grad = True
            model.module.densenet121.features3.denseblock2[BLOCK_CONFIG[1]-i-1][2].weight.requires_grad = True    
            model.module.densenet121.features3.denseblock2[BLOCK_CONFIG[1]-i-1][5].weight.requires_grad = True
    ...
    if LAST_PARALLEL_BLOCKS>=3:
        ...
        for j in range(BLOCK_CONFIG[2]):
            ...
            for k in [2,5]:
                ...
                if LAST_FROZEN_PARALLEL_LAYER>=3: 
                    model.module.densenet121.features0.denseblock3[j][k].weight.requires_grad = False
                    model.module.densenet121.features1.denseblock3[j][k].weight.requires_grad = False
                    model.module.densenet121.features2.denseblock3[j][k].weight.requires_grad = False
                    model.module.densenet121.features3.denseblock3[j][k].weight.requires_grad = False
                else:                    
                    model.module.densenet121.features0.denseblock3[j][k].weight.requires_grad = True
                    model.module.densenet121.features1.denseblock3[j][k].weight.requires_grad = True
                    model.module.densenet121.features2.denseblock3[j][k].weight.requires_grad = True
                    model.module.densenet121.features3.denseblock3[j][k].weight.requires_grad = True
        ...
        if LAST_PARALLEL_BLOCKS!=3:
            ...
            if LAST_FROZEN_PARALLEL_LAYER>=3: 
                model.module.densenet121.features0.transition3.conv.weight.requires_grad = False
                model.module.densenet121.features1.transition3.conv.weight.requires_grad = False
                model.module.densenet121.features2.transition3.conv.weight.requires_grad = False
                model.module.densenet121.features3.transition3.conv.weight.requires_grad = False
            else:
                model.module.densenet121.features0.transition3.conv.weight.requires_grad = True
                model.module.densenet121.features1.transition3.conv.weight.requires_grad = True
                model.module.densenet121.features2.transition3.conv.weight.requires_grad = True
                model.module.densenet121.features3.transition3.conv.weight.requires_grad = True
    ...
    if LAST_PARALLEL_BLOCKS>=4:
        ...
        for j in range(BLOCK_CONFIG[3]):
            ...
            for k in [2,5]:
                ...
                if LAST_FROZEN_PARALLEL_LAYER>=4: 
                    model.module.densenet121.features0.denseblock4[j][k].weight.requires_grad = False
                    model.module.densenet121.features1.denseblock4[j][k].weight.requires_grad = False
                    model.module.densenet121.features2.denseblock4[j][k].weight.requires_grad = False
                    model.module.densenet121.features3.denseblock4[j][k].weight.requires_grad = False
                else:                    
                    model.module.densenet121.features0.denseblock4[j][k].weight.requires_grad = True
                    model.module.densenet121.features1.denseblock4[j][k].weight.requires_grad = True
                    model.module.densenet121.features2.denseblock4[j][k].weight.requires_grad = True
                    model.module.densenet121.features3.denseblock4[j][k].weight.requires_grad = True
...
def inference():
    ...
    dataset = DDSMDataSetHDF5_256_2Cls(data_dir=HDF5_DATA_DIR,
                                    set_idx = idx,
                                    transform=transforms.Compose([
                                        transforms.CenterCrop(224),
                                        transforms.ToTensor(),
    ...
    criterion = nn.CrossEntropyLoss().cuda()
    (val_loss, val_top1) = validate(loader, model, criterion)
    print(val_top1)
