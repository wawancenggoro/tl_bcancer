...
def main():
    ...
    if LAST_PARALLEL_BLOCKS>=1:
        ...
        for i in range(3):
            model.module.densenet121.features0.denseblock1[5-i][2].weight.requires_grad = True    
            model.module.densenet121.features0.denseblock1[5-i][5].weight.requires_grad = True
            model.module.densenet121.features1.denseblock1[5-i][2].weight.requires_grad = True    
            model.module.densenet121.features1.denseblock1[5-i][5].weight.requires_grad = True
            model.module.densenet121.features2.denseblock1[5-i][2].weight.requires_grad = True    
            model.module.densenet121.features2.denseblock1[5-i][5].weight.requires_grad = True
            model.module.densenet121.features3.denseblock1[5-i][2].weight.requires_grad = True    
            model.module.densenet121.features3.denseblock1[5-i][5].weight.requires_grad = True
